...
`;var Ut=Object.defineProperty,Ht=Object.getOwnPropertyDescriptor,Tt=(r,t,e,i)=>{for(var s=i>1?void 0:i?Ht(t,e):t,o=r.length-1,n;o>=0;o--)(n=r[o])&&(s=(i?n(t,e,s):n(s))||s);return i&&s&&Ut(t,e,s),s};let D=class extends P{render(){return At`
      <header>
        <h1 class="logo">
          <a href="/"
    ...
    `];D=Tt([xt("c-header")],D);export{P as a,it as f,st as i,Ot as r,xt as t,j as u,At as x};
